...
# Suppress all logs except for the ones we explicitly print
logging.basicConfig(
    level=logging.WARNING,  # Set the default logging level to WARNING
...
OPENROUTER_API_KEY = "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"  # Replace with your OpenRouter API key
